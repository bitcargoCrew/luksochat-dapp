export default {
  ...
  colors: {
    ...
    primary: '#4B9F28', // primary button and link color
    secondary: '#4B9F28>', // secondary color - can be used for hover states
  ...
  buttons: {
    ...
    primary: {
      ...
      bg: 'primary',
      '&:hover': {
        boxShadow: 'rgba(150, 232, 116, 1) 0px 9px 20px -5px',
      },
    },
    whiteButton: {
      variant: 'buttons.defaultBtn',
